"""
Deep declarative node. Thanks and credits to:

Source: https://github.com/anucvml/ddn

Paper: https://arxiv.org/abs/1909.04866
"""
            ...
            for indices in indices_list:
                ...
                if unconstrained:
                    gradients_subset = AbstractDeclarativeNode.gradient(self,
                                                                        *xs_subset, y=y_subset, v=v_subset,
                                                                        ctx=ctx_subset)
...
# https://github.com/MIT-SPARK/C-3PO/blob/main/c3po/utils/ddn/node.py
